...
-- })
--
-- TODO NTS : Working on volume widget here
...
vol.y = 50 -- TODO make this dynamic instead of hardcoded
...
local update_volume = function(code)
    ...
    awful.spawn.easy_async(cmd, function(stdout, stderr, reason, exit_code)
        ...
        naughty.notify({text = "Doing"})
        naughty.notify({text = "Vol Am "..vol:get_children_by_id("volume-bar")[1].value  })
        naughty.notify({text = "Done"})

        vol:get_children_by_id("volume-bar").value = volume_amount
